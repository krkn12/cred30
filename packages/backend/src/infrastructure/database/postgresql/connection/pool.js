...
exports.initializeDatabase = exports.generateReferralCode = exports.generateId = exports.setDbPool = exports.getDbPool = exports.sql = exports.pool = void 0;
...
exports.sql.begin = async (callback) => {
...
const originalQuery = exports.pool.query;
exports.pool.query = async function (text, params) {
