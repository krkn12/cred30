...
-- Usando UUID para compatibilidade com a tabela users

-- Verificar tipo da coluna id na tabela users
DO $$
BEGIN
    -- Tabela user_sessions (corrigida para usar UUID)
    ...
    -- Tabela notification_settings (corrigida para usar UUID)
    ...
    -- Tabela notifications (corrigida para usar UUID)
    ...
    -- Tabela user_statistics (corrigida para usar UUID)
    ...
    -- Tabela referrals (corrigida para usar UUID)
    ...
    -- Adicionar coluna referred_by na tabela users se não existir (usando UUID)
    ...
    -- Tabela support_tickets (corrigida para usar UUID)
    ...
    -- Tabela fee_history (corrigida para usar UUID)
