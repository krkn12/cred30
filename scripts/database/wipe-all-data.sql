...
-- MANTÉM APENAS a estrutura das tabelas (schema)
-- ATENÇÃO: ESTA OPERAÇÃO É IRREVERSÍVEL!

-- Desabilitar temporariamente as verificações de chave estrangeira
SET session_replication_role = replica;

-- Limpar todas as tabelas em ordem de dependência inversa
...
-- 5. Tabelas de relatórios e dashboard
TRUNCATE TABLE daily_reports RESTART IDENTITY CASCADE;
TRUNCATE TABLE admin_dashboard RESTART IDENTITY CASCADE;

-- 6. Tabela principal de usuários (MANTER APENAS O ADMIN)
-- Remover todos os usuários exceto o admin principal
