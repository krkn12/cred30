...
# =============================================================================
-- LIMPEZA FINAL COMPLETA - DOCKER DIRETO - SEM ARQUIVOS EXTERNOS
-- =============================================================================
...
echo -e "${RED}============================================================================${NC}"
echo -e "${RED}LIMPEZA FINAL COMPLETA - DOCKER DIRETO${NC}"
echo -e "${RED}============================================================================${NC}"
echo
...
# Comandos SQL diretos para apagar tudo (sem RAISE NOTICE)
SQL_COMMANDS="
BEGIN;
